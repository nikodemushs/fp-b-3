...
import NavbarLogoPutih from "./Navbar";
import NavbarLogoBiru from "./Navbar2";
    ...
    <div>
      <footer class="bg-white dark:bg-gray-900">
        <div class="mx-auto max-w-screen-2xl px-4 pb-6 pt-16 sm:px-6 lg:px-8 lg:pt-24">
          <div class="gap-y-4 sm:flex sm:flex-row sm:justify-between sm:gap-x-20 ">
            <div>
            ...
            <div class="hidden pt-10 pl-6 sm:pt-0 sm:px-0 lg:block">
              <GoogleMaps />
            </div>
          </div>
          <div class="block pt-10 lg:hidden px-6 md:px-0">
            <GoogleMaps />
          </div>
